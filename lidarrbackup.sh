...
if [ ${choice} == "B" ] || [ ${choice} == "b" ]; then
  ...
  tar --exclude='./lidarr.db-*' --exclude='lidarr.pid' -zcvpf ${POOL_PATH}/${BACKUP_PATH}/${BACKUP_NAME} ./*

  echo
  echo "tar --exclude='./lidarr.db-*' --exclude='lidarr.pid' -zcvpf ${POOL_PATH}/${BACKUP_PATH}/${BACKUP_NAME} ./*"
  echo
